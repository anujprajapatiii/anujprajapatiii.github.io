...
export const semanticGroups = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: "button-primary-background-hover", light: "neutral-700", dark: "neutral-325" },
      { name: "button-primary-background-active", light: "neutral-100", dark: "neutral-white" },
      { name: "button-primary-foreground", light: "neutral-100", dark: "neutral-800" },
      { name: "button-primary-foreground-active", light: "neutral-800", dark: "neutral-800" },
